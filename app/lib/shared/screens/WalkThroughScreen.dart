...
class _WalkThroughScreenState extends State<WalkThroughScreen> {
  ...
  Widget sDDotIndicator({required bool isActive}) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(color: isActive ? appColorPrimary : Color(0xFF7E869B), borderRadius: BorderRadius.all(Radius.circular(50))),
    );
  }
                ...
                children: <Widget>[
                  Column(
                    children: <Widget>[
                      ...
                      SizedBox(height: 4),
                      Center(
                        child: Padding(padding: EdgeInsets.only(top: 40), child: Text('Header text here \n more text here', textAlign: TextAlign.center, style: boldTextStyle(size: 25))),
                      ),
                    ],
                  ),
                  Column(
                    children: <Widget>[
                      ...
                      Center(
                        child: Padding(
                          ...
                          child: Text('Header text here \n full text', textAlign: TextAlign.center, style: boldTextStyle(size: 25)),
                        ),
                      ),
                    ],
                  ),
                  Column(
                    children: <Widget>[
                      Padding(
                        padding: EdgeInsets.only(top: size.height * 0.1, left: 10, right: 10),
                        child: Image(
                          image: AssetImage('images/walkthrough3.png'),
                          height: size.height * 0.3,
                          width: size.width,
                          fit: BoxFit.contain,
                        ),
                      ...
                      Center(
                        child: Padding(
                          padding: EdgeInsets.only(top: 40),
                          child: Text('Header text here ', textAlign: TextAlign.center, style: boldTextStyle(size: 25)),
                        ),
                      ),
